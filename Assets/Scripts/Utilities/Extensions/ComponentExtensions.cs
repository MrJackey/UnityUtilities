...
namespace Jackey.Utilities.Extensions {
	public static class ComponentExtensions {
		/// <summary>
		/// Gets a component on the same game object as the source component.
		...
		/// <summary>
		/// Add a new component to the game object of the source component
		/// </summary>
		...
		/// <summary>
		/// Check if the game object the source component is attached to has a component of a certain type
		/// </summary>
		...
		/// </summary>
		/// <returns>Returns true if a component is found, otherwise false</returns>
		public static bool TryGetComponentInParent<T>(this Component source, out T component, bool includeInactive = false) where T : Component {
